...
const Game = {
  ...
  setupInput() {
    ...
    document.getElementById('btnDeathMenu')?.addEventListener('click', () => showScreen('mainMenu'));
    ...
    if (localStorage.getItem('ascent_save_alt')) {
      ...
      const savedAlt = localStorage.getItem('ascent_save_alt');
      document.getElementById('recordAlt').textContent = savedAlt + 'm';
    }
  ...
  descend() {
    ...
    showScreen('mainMenu');
    document.getElementById('btnContinue').style.display = '';
    document.getElementById('recordAlt').textContent = Math.floor(this.player.altitude) + 'm';
  },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (localStorage.getItem('ascent_save_alt')) {
    document.getElementById('btnContinue').style.display = '';
    document.getElementById('recordAlt').textContent = localStorage.getItem('ascent_save_alt') + 'm';
  }
});
